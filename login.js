...
/* ==============================================================
   NORTH CAPITAL 3.1 · BUILD 31.1 · BRAND EXPERIENCE
   Identity lock: brand, shell, typography, material and spacing.
   ============================================================= */
:root{
  --nc31-canvas:#020912;
  --nc31-canvas-soft:#04111d;
  --nc31-petroleum:#071827;
  --nc31-panel:rgba(7,24,39,.86);
  --nc31-panel-raised:rgba(10,31,50,.92);
  --nc31-border:rgba(78,137,181,.25);
  --nc31-border-bright:rgba(93,165,218,.40);
  --nc31-gold:#d5aa55;
  --nc31-gold-light:#f1dfab;
  --nc31-blue:#2e7dff;
  --nc31-green:#2ed47a;
  --nc31-text:#f4f7fb;
  --nc31-muted:#91a4b6;
  --nc31-shadow:0 20px 52px rgba(0,0,0,.28);
}
body.dark{
  --bg1:#071827;--bg2:#0a1c2d;--bg3:#10283e;--accent:#2e7dff;
  --green:#2ed47a;--red:#ff5c66;--yellow:#f4bd3e;--purple:#9363f4;
  --text2:#91a4b6;--border:#173a54;--shadow:rgba(0,0,0,.34);
  color:var(--nc31-text)!important;
  background:
    radial-gradient(circle at 72% -12%,rgba(31,94,143,.27),transparent 35%),
    radial-gradient(circle at 4% 72%,rgba(15,62,101,.13),transparent 32%),
    linear-gradient(145deg,#020912 0%,#04111d 47%,#020a13 100%) fixed!important;
}
body.dark:before{content:"";position:fixed;inset:0;pointer-events:none;z-index:-1;background:linear-gradient(115deg,rgba(255,255,255,.012),transparent 34%,rgba(25,91,140,.025) 72%,transparent);}
#app{padding-left:224px!important;padding-top:86px!important;background:transparent!important;}
.nc15-topbar{
  height:82px!important;grid-template-columns:310px 210px 305px 1fr auto!important;
  padding:0 22px!important;gap:12px!important;
  background:linear-gradient(180deg,rgba(3,13,23,.97),rgba(3,14,25,.91))!important;
  border-bottom:1px solid rgba(72,135,180,.30)!important;
  box-shadow:0 10px 36px rgba(0,0,0,.30),inset 0 -1px 0 rgba(213,170,85,.05)!important;
  backdrop-filter:blur(24px) saturate(135%)!important;
}
.nc31-brand{height:62px;display:flex!important;align-items:center!important;gap:9px!important;overflow:visible;}
.nc31-brand img{width:254px!important;height:56px!important;object-fit:contain;object-position:left center;filter:drop-shadow(0 5px 13px rgba(0,0,0,.32));}
.nc31-brand small{font-size:7px;color:#70879a;white-space:nowrap;border-left:1px solid rgba(103,144,174,.25);padding-left:9px;letter-spacing:.04em;}
.nc15-mission-status,.nc15-score-header,.nc15-market-status,.nc15-header-actions{
  height:50px!important;border:1px solid rgba(73,132,174,.24)!important;
  background:linear-gradient(145deg,rgba(8,29,47,.74),rgba(5,20,34,.66))!important;
  border-radius:10px!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.025),0 7px 18px rgba(0,0,0,.12)!important;
}
.nc15-mission-status{padding:0 14px!important}.nc15-mission-status>i{background:var(--nc31-green)!important;box-shadow:0 0 0 4px rgba(46,212,122,.08),0 0 15px rgba(46,212,122,.70)!important;}
.nc15-mission-status strong{font-size:11px!important;color:#f5f8fb}.nc15-mission-status span{font-size:8px!important;color:#8fa4b7!important;margin-top:2px;}
.nc15-score-header{gap:7px!important;padding:0 14px!important}.nc15-score-header span{font-size:8px!important}.nc15-score-header strong{font-size:26px!important;color:#35dd89!important;text-shadow:0 0 18px rgba(53,221,137,.28)}.nc15-score-header em{font-size:10px;letter-spacing:1.5px!important;color:#e6b84f!important}.nc15-score-header small{font-size:7px!important}
.nc15-market-status{padding:0 13px!important}.nc15-market-status span{font-size:8px!important}.nc15-market-status b{font-size:7px!important;letter-spacing:.05em}.nc15-market-status strong{font-size:13px!important;color:#f2f7fb}
.nc15-header-actions{padding:0 8px!important;gap:8px!important}.nc15-icon-btn{width:32px!important;height:32px!important;background:linear-gradient(145deg,#0d2a43,#071b2d)!important;border:1px solid rgba(87,149,196,.22)!important}.nc15-user>b{background:linear-gradient(145deg,#17416a,#0a2946)!important;border:1px solid rgba(93,157,205,.28)}
.nc15-sidebar{top:82px!important;width:224px!important;padding:15px 12px!important;background:linear-gradient(180deg,rgba(2,11,20,.97),rgba(3,14,24,.96))!important;border-right:1px solid rgba(57,111,150,.31)!important;box-shadow:8px 0 34px rgba(0,0,0,.18)!important;scrollbar-width:thin;scrollbar-color:#163b59 transparent;}
.nc15-sidebar nav{gap:3px!important}.nc31-nav-label{display:block;margin:12px 12px 6px;font-size:7px;font-weight:800;text-transform:uppercase;letter-spacing:.13em;color:#506c82}.nc31-nav-label:first-child{margin-top:2px}
.nc15-sidebar button{height:39px!important;border-radius:8px!important;padding:0 13px!important;gap:12px!important;font-size:10px!important;transition:background .18s ease,border-color .18s ease,transform .18s ease,color .18s ease!important}.nc15-sidebar button i{font-size:15px!important;color:#6f879a;transition:.18s}.nc15-sidebar nav button.on{position:relative;background:linear-gradient(90deg,rgba(27,91,173,.76),rgba(12,49,88,.82))!important;border-color:rgba(51,125,215,.62)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.04),0 8px 20px rgba(0,70,160,.13)!important}.nc15-sidebar nav button.on:before{content:"";position:absolute;left:-13px;top:7px;bottom:7px;width:3px;border-radius:0 3px 3px 0;background:#48a5ff;box-shadow:0 0 11px rgba(72,165,255,.75)}.nc15-sidebar nav button.on i{color:#d9edff}.nc15-sidebar button:hover{transform:translateX(2px)!important;background:rgba(16,52,82,.65)!important;color:#fff!important}
.nc15-sidebar-tools{margin-top:11px!important;padding-top:11px!important}.nc15-sidebar-tools button{height:33px!important}
.nc15-sidebar-card{min-height:170px!important;padding:15px!important;background:radial-gradient(circle at 75% 85%,rgba(45,125,255,.18),transparent 32%),linear-gradient(145deg,#0a3262,#061b34)!important;border-color:rgba(46,125,255,.48)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 14px 30px rgba(0,35,85,.22)!important}.nc15-sidebar-card>span{font-size:8px!important;color:var(--nc31-gold)!important;text-transform:uppercase;letter-spacing:.1em}.nc15-sidebar-card>strong{font-size:14px!important;margin-top:3px}.nc15-sidebar-card p{font-size:8px!important}.nc15-orbit{width:86px!important;height:86px!important;margin-top:5px!important}
.nc15-market-ribbon{height:31px!important;color:#7f93a5!important;border-bottom:1px solid rgba(61,110,146,.13);margin-bottom:8px;padding-right:12px!important}
.nc15-card,.card,.tw,.policy-card,.strategy-card,.north-goal-card,.north-checklist-card{
  background:
    linear-gradient(130deg,rgba(255,255,255,.024),transparent 24%),
    linear-gradient(145deg,rgba(8,28,45,.94),rgba(4,18,31,.95))!important;
  border-color:rgba(63,119,158,.34)!important;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.028),0 15px 35px rgba(0,0,0,.18)!important;
}
.nc15-card{border-radius:10px!important;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease!important}.nc15-card:hover{transform:translateY(-2px);border-color:rgba(78,150,203,.49)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 20px 44px rgba(0,0,0,.25),0 0 0 1px rgba(39,111,166,.04)!important}
.nc15-card-head{color:#dce6ee!important;font-weight:700;letter-spacing:.065em!important}.nc15-card-head small{color:#5eaaff!important}
.nc15-wealth-card>strong{font-size:32px!important;letter-spacing:-1.2px}.nc15-wealth-card{background:radial-gradient(circle at 82% 18%,rgba(39,124,255,.12),transparent 31%),linear-gradient(145deg,rgba(9,31,50,.98),rgba(4,18,31,.96))!important;border-color:rgba(48,119,196,.47)!important}
.nc15-dashboard-grid{gap:11px!important;margin-bottom:11px!important}.nc15-row-one{grid-template-columns:1.34fr 1fr .95fr 1.72fr!important}
.nc15-world-map path{filter:drop-shadow(0 0 5px rgba(37,119,225,.13))}.nc15-dashboard-heatmap article{transition:transform .18s ease,filter .18s ease!important}.nc15-dashboard-heatmap article:hover{transform:scale(1.045);filter:brightness(1.15)}
.lock{background:radial-gradient(circle at 50% 12%,#0b2841 0,#04111d 38%,#020912 100%)!important}.lock-box{width:390px!important;padding:31px 34px!important;background:linear-gradient(145deg,rgba(8,29,47,.97),rgba(3,15,26,.98))!important;border:1px solid rgba(82,144,187,.37)!important;box-shadow:0 28px 76px rgba(0,0,0,.47),inset 0 1px 0 rgba(255,255,255,.035)!important}.lock-icon{display:none!important}.nc31-login-brand{display:block!important;margin:0 auto 16px!important}.nc31-login-brand img{width:100%!important;height:72px!important;object-fit:contain}.lock-box>p{font-size:10px!important;color:#8499ab!important}.lock-box input{background:#061522!important;border-color:#1c405b!important;color:#fff!important}.lock-box .bp{background:linear-gradient(135deg,#246fe8,#1553b3)!important;box-shadow:0 10px 24px rgba(24,97,205,.25)}
@media(max-width:1380px){.nc15-topbar{grid-template-columns:280px 185px 265px 1fr auto!important}.nc31-brand img{width:224px!important}.nc31-brand small{display:none}.nc15-score-header em{display:none}.nc15-row-one{grid-template-columns:1fr 1fr!important}}
@media(max-width:900px){#app{padding-left:0!important;padding-top:60px!important}.nc15-sidebar{top:58px!important}.nc15-mobile-nav{background:linear-gradient(180deg,#041523,#020d17)!important}.nc15-mobile-nav strong{font-family:Georgia,'Times New Roman',serif;letter-spacing:.08em;color:#f4f0e8}.nc15-row-one{grid-template-columns:1fr!important}}

/* =========================================================
   NORTH CAPITAL 3.1 — BUILD 31.2 · EXECUTIVE DASHBOARD
   Pixel-density and hierarchy refinement for 1366–1600 px.
   ========================================================= */
:root{
  --nc312-gap:10px;
  --nc312-radius:10px;
  --nc312-card:#071827;
  --nc312-card-2:#061522;
  --nc312-line:rgba(71,135,181,.30);
}

/* Header: visually lighter, more integrated, less card-like. */
.nc15-topbar{
  height:74px!important;
  grid-template-columns:minmax(245px,300px) minmax(170px,205px) minmax(230px,285px) 1fr auto!important;
  gap:12px!important;
  padding:0 16px!important;
  border-bottom:1px solid rgba(66,126,169,.28)!important;
  box-shadow:0 10px 30px rgba(0,0,0,.20)!important;
}
.nc31-brand{height:58px!important;min-width:0!important}
.nc31-brand img{width:100%!important;max-width:282px!important;height:54px!important}
.nc31-brand small{display:none!important}
.nc15-mission-status,.nc15-score-header,.nc15-market-status,.nc15-header-actions{
  height:46px!important;
  border-radius:10px!important;
  background:linear-gradient(145deg,rgba(7,25,41,.88),rgba(4,17,29,.82))!important;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.025)!important;
}
.nc15-score-header{min-width:0!important}
.nc15-header-actions{white-space:nowrap}

/* Sidebar: slightly narrower so the content can match the approved proportions. */
.nc15-sidebar{top:74px!important;width:210px!important;padding:14px 10px!important}
.nc15-sidebar button{height:38px!important}
.nc15-sidebar-card{display:none!important}
.nc15-sidebar-tools{margin-top:auto!important}
body:has(.nc15-sidebar) .main{margin-left:210px!important}

/* Dashboard canvas and grid density. */
.nc15-dashboard-page{
...
.nc15-market-ribbon{height:28px!important;margin-bottom:7px!important}
.nc15-dashboard-grid{gap:var(--nc312-gap)!important;margin-bottom:var(--nc312-gap)!important}
.nc15-row-one{grid-template-columns:1.24fr 1.02fr .92fr 1.50fr!important}
.nc15-row-two{grid-template-columns:1.18fr 1.52fr 1.06fr .88fr!important}
.nc15-row-three{grid-template-columns:1.14fr 1.04fr 1.28fr .88fr!important}

.nc15-card{
  border-radius:var(--nc312-radius)!important;
  border:1px solid var(--nc312-line)!important;
  background:
    radial-gradient(circle at 90% 0,rgba(34,109,178,.075),transparent 27%),
    linear-gradient(145deg,rgba(7,25,41,.98),rgba(4,17,29,.98))!important;
  box-shadow:inset 0 1px 0 rgba(255,255,255,.028),0 10px 26px rgba(0,0,0,.18)!important;
}
.nc15-card:hover{transform:translateY(-1px)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.035),0 14px 32px rgba(0,0,0,.22)!important}
.nc15-card-head{height:34px!important;padding:0 12px!important;font-size:8.5px!important}

/* First row now matches the compact executive reference. */
.nc15-wealth-card,.nc15-performance-card,.nc15-dollar-card,.nc15-allocation-card{
  min-height:164px!important;
  height:164px!important;
  padding:15px!important;
}
.nc15-wealth-card>strong{font-size:29px!important;margin:7px 0 10px!important}
.nc15-wealth-stats{gap:30px!important}.nc15-sparkline{height:48px!important;margin-top:5px!important}
.nc15-performance-card{gap:12px!important}.nc15-performance-card strong{font-size:17px!important;margin:5px 0!important}.nc15-mini-spark{height:35px!important}
.nc15-dollar-top strong{font-size:17px!important}.nc15-dollar-row{margin:5px 0!important}.nc15-dollar-row i{width:27px!important;height:27px!important}
.nc15-allocation-layout{grid-template-columns:128px 1fr!important;height:112px!important}.nc15-allocation-donut{width:112px!important;height:112px!important}.nc15-allocation-donut:before{inset:22px!important}.nc15-allocation-legend{gap:6px!important}

/* Second row. */
.nc15-geo-card,.nc15-evolution-card,.nc15-radar-card,.nc15-events-card{min-height:210px!important;height:210px!important}
.nc15-world-map{height:125px!important}.nc15-geo-legend{padding-bottom:8px!important}
.nc15-evolution-chart{height:145px!important}.nc15-radar{height:166px!important}
.nc15-upcoming-events>div{padding:6px 0!important}

/* Third row. */
.nc15-goals-card,.nc15-heatmap-card,.nc15-insights-card{min-height:238px!important;height:238px!important}
.nc15-alert-stack{height:238px!important;display:grid!important;grid-template-rows:1fr 1fr!important;gap:10px!important}
.nc15-alert-stack .nc15-card{min-height:0!important;height:auto!important}
.nc15-dashboard-heatmap article{height:48px!important;padding:7px!important}
.nc15-dashboard-heatmap strong{font-size:8px!important}.nc15-dashboard-heatmap b{font-size:11px!important}
.nc15-goals-list>div{margin:6px 0!important}.nc15-insights-list>div{padding:7px 0!important}

/* Intelligence cockpit refinement. */
.nc-intelligence-dashboard{max-width:none!important;margin-left:210px!important;padding-left:12px!important;padding-right:12px!important}
.nc-intelligence-dashboard .nc-intelligence-hero{gap:10px!important}
.nc-intelligence-dashboard .nc-score-gauge-card{background:radial-gradient(circle at 50% 55%,rgba(255,153,0,.10),transparent 33%),linear-gradient(145deg,rgba(7,25,41,.98),rgba(4,17,29,.98))!important}

/* Typography refinement: less tiny text, more consistency. */
.nc15-dashboard-page,.nc-intelligence-dashboard{font-family:Inter,"Segoe UI",Arial,sans-serif!important}
.nc15-card span,.nc15-card small{line-height:1.35}

/* Responsive: retain 4-column executive dashboard on common 1366px notebooks. */
@media (max-width:1380px){
  .nc15-topbar{grid-template-columns:245px 180px 230px 1fr auto!important}
  .nc31-brand img{max-width:235px!important}
  .nc15-score-header em{display:inline!important;font-size:9px!important}
  .nc15-row-one{grid-template-columns:1.22fr 1fr .92fr 1.42fr!important}
  .nc15-row-two{grid-template-columns:1.12fr 1.45fr 1fr .84fr!important}
  .nc15-row-three{grid-template-columns:1.08fr 1fr 1.18fr .84fr!important}
}
@media (max-width:1160px){
  .nc15-topbar{grid-template-columns:230px 170px 1fr auto!important}
  .nc15-market-status{display:none!important}
  .nc15-row-one,.nc15-row-two,.nc15-row-three{grid-template-columns:1fr 1fr!important}
  .nc15-wealth-card,.nc15-performance-card,.nc15-dollar-card,.nc15-allocation-card,
  .nc15-geo-card,.nc15-evolution-card,.nc15-radar-card,.nc15-events-card,
  .nc15-goals-card,.nc15-heatmap-card,.nc15-insights-card{height:auto!important;min-height:190px!important}
}
