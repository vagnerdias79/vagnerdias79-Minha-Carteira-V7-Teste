...
function showPg(id, el) {
  ...
  if (id === 'fi') buildFamilyIntelligence();if (id === 'go') buildNorthGoals();if (id === 'vg') setTimeout(buildNorthMissionControl,0);if (id === 'vg') setTimeout(buildNorthMissionControl,0);
...
document.addEventListener("DOMContentLoaded",function(){northLoadFoundation();setTimeout(function(){buildNorthMissionControl();buildNorthGoals();},200);});
