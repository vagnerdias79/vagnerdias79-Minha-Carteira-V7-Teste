...
function showPg(id, el) {
  ...
  if (id === 'fi'){buildFamilyIntelligence();setTimeout(function(){buildNorthScore2();buildNorthGaugeSemantics();buildNorthScoreCockpit();buildNorthCockpitGradeNote();buildNorthHeatmap();buildNorthTimeline();buildNorthExecutiveIntelligence();buildNorthExecutiveIntelligence();northAnimateNumbers();},0);}if (id === 'go'){buildNorthGoals();setTimeout(function(){buildNorthChecklist();buildNorthGoalRings();northAnimateNumbers();},0);}if (id === 'vg') setTimeout(function(){buildNorthMissionControl();buildNorthMissionAI();buildNorthExecutiveHome();buildNorthScoreCockpit();buildNorthCockpitGradeNote();northAnimateNumbers();},0);if (id === 'na') setTimeout(function(){buildNorthAI();buildNorthConversationalAdvisor();buildNorthCioBrief();buildNorthCioBrief();northAnimateNumbers();},0);
...
function renderAll() {
  ...
  setTimeout(function(){
    ...
    if(document.getElementById("pg-fi")&&document.getElementById("pg-fi").classList.contains("on")){
      buildNorthScore2();buildNorthGaugeSemantics();buildNorthScoreCockpit();buildNorthCockpitGradeNote();buildNorthHeatmap();buildNorthTimeline();buildNorthExecutiveIntelligence();
    }
