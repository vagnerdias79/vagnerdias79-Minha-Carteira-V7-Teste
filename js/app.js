...
function renderAll() {
  ...
  setTimeout(function(){
    ...
    if(document.getElementById("pg-fi")&&document.getElementById("pg-fi").classList.contains("on")){
      buildNorthScore2();buildNorthGaugeSemantics();buildNorthHeatmap();buildNorthTimeline();buildNorthExecutiveIntelligence();
    }
...
document.addEventListener("DOMContentLoaded",function(){northLoadFoundation();setTimeout(function(){buildNorthMissionControl();buildNorthMissionAI();buildNorthExecutiveHome();buildNorthGoals();buildNorthGoalRings();buildNorthChecklist();northAnimateNumbers();},200);});
